...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Product createProduct(String name, String category, String brand, double price, String description) {
        Product product = productRepository.create(name, category, brand, price, description);
