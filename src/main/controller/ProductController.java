...
public class ProductController {
     ...
     */
    public Product createProduct(String username, String name, String category, String brand, double price, String description) {
        ...
        Product product = productService.createProduct(name, category, brand, price, description);
